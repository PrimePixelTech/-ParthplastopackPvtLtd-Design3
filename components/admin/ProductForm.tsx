  ...
  return (
    <div className="max-w-4xl bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-10">
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-8">
        ...
        {/* Product Images with Cloudinary ImageUploader */}
        <div className="pt-4 border-t border-gray-100">
          <h3 className="text-lg font-semibold text-slate-900 mb-4">Product Images</h3>
          <ImageUploader
            label="Main Image & Gallery"
            description="First image is the main showcase image. Drag and drop to upload multiple images (JPG, PNG, WebP up to 10MB)."
            multiple
            maxFiles={8}
